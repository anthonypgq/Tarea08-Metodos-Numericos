...
x_data = np.array([0.2, 0.3, 0.6, 0.9, 1.1, 1.3, 1.4, 1.6])
y_data = np.array([0.050446, 0.098426, 0.33277, 0.72660,
                  1.0972, 1.5697, 1.8487, 2.5015])
...
# Ajuste de polinomios de grados 1, 2 y 3
degrees = [1, 2, 3]
coeffs = []
errors = []
polynomials = []
...
for degree in degrees:
    coeff = np.polyfit(x_data, y_data, degree)  # Ajuste por mínimos cuadrados
    p = np.poly1d(coeff)
    y_pred = p(x_data)
